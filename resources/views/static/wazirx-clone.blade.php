...
<body class="header-shadow" id="ico">
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="contentall">
                                <div class="ovr">
                                    <div itemscope itemtype="http://schema.org/CreativeWork">
                                        <div class="ban_tirt">
                                            <h1 itemprop="name">WazirX Clone Solution</h1>
                                        </div>
                                        <p itemprop="text">Transform your crypto exchange vision into reality with our cutting-edge WazirX clone. Seize unparalleled advantages and revolutionize online cryptocurrency trading effortlessly with our advanced solutions.</p>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 text-center"> <img class="magic"
                                src="{{ asset('images/wazirx-clone/banner-img.webp') }}" alt=" " title=" " width="410px"> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="common_spacing gray_bg">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="title-th sec_tit underline">Elevate Your Crypto Exchange with Our Top-Tier WazirX Clone</h2>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <p class="text-center">In today’s rapidly digitalizing world, the demand for user-friendly crypto exchanges is soaring. Our WazirX clone empowers you to create and launch a cutting-edge cryptocurrency exchange app within a week, setting new standards in the industry.
                            <br><br>
                        Unlock limitless opportunities with our state-of-the-art WazirX clone software, designed to elevate your presence in the dynamic crypto market. Offering a range of trading options and diverse payment methods, this app ensures a streamlined and effortless experience for your users.
                        </p>
                    </div>
    ...
    <script src="js/vendor.js" type="e82f0cc907e73863f1578826-text/javascript"></script>
    <script src="js/plugins.js" type="e82f0cc907e73863f1578826-text/javascript"></script>
    <script src="js/main.js" type="e82f0cc907e73863f1578826-text/javascript"></script>
    <script src="build/js/intlTelInput.js" type="e82f0cc907e73863f1578826-text/javascript"></script>
    ...
    <script type="e82f0cc907e73863f1578826-text/javascript">
...
btn.addEventListener('click', function handleClick() {
  if (box.style.display === 'none') {
    ...
    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="e82f0cc907e73863f1578826-|49" defer></script>
</body>
