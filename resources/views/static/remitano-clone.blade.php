            ...
            <div class="banner_content">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="contentall">
                                <div class="ovr">
                                    <div itemscope itemtype="http://schema.org/CreativeWork">
                                        <div class="ban_tirt">
                                            <h1 itemprop="name">Remitano Clone App</h1>
                                        </div>
                                        <p itemprop="text">Unlock the potential of a sophisticated, high-performance cryptocurrency exchange with our cutting-edge Remitano clone app. Experience unparalleled ease in buying and selling digital assets, making transactions faster and more seamless than ever before.</p>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 text-center" style=""> <img
                                class="magic" src="{{ asset('images/remitano-clone/banner-img.webp') }}" alt=" " title=" " width="450px"> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="common_spacing gray_bg">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="title-th sec_tit underline">Maximize Crypto Trading Efficiency with Remitano Clone</h2>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <p class="text-center">Curious about how crypto traders swiftly exchange tokens? As the cryptocurrency market experiences exponential growth, the demand for efficient trading platforms has surged. Our Remitano clone delivers an advanced solution with rapid transaction capabilities and robust infrastructure.
                            <br><br>
                        Our pre-built software, modeled after the Remitano exchange, empowers you to leverage market trends with ease. It also supports diverse financial functions, including lending, crowdfunding, and liquidity staking, broadening your business potential. Connect with our experts for a tailored quote that meets your specific needs. </p>
                    </div>
                    <div class="text-center cta_mine txt">
                        <a rel="nofollow" href="{{ url('consultation') }}"
                            class="nectar-button medium regular accent-color regular-button nec-btn med-btn"><span>Schedule A Meeting Consult With Our Experts</span></a>
                    </div>
...
<script src="js/jquery.min.js" type="aa232ae1e3b843950aa756fc-text/javascript"></script>
<script src="js/vendor.js" type="aa232ae1e3b843950aa756fc-text/javascript"></script>
<script src="js/plugins.js" type="aa232ae1e3b843950aa756fc-text/javascript"></script>
<script src="js/main.js" type="aa232ae1e3b843950aa756fc-text/javascript"></script>
<script src="build/js/intlTelInput.js" type="aa232ae1e3b843950aa756fc-text/javascript"></script>
<!-- header (top) -->
...
<script type="aa232ae1e3b843950aa756fc-text/javascript">
...
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="aa232ae1e3b843950aa756fc-|49" defer></script>
</div>
