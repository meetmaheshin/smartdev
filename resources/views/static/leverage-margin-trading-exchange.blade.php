@extends('layouts.static')
    @section('title', 'Leverage and Margin Trading Exchange')
                            ...
                            <div class="contentall">
                                <div class="ovr">
                                    <div itemscope itemtype="http://schema.org/CreativeWork">
                                        <div class="ban_tirt">
                                            <h1 itemprop="name">Leverage and Margin Trading Exchange Development</h1>
                                        </div>
                                        <p itemprop="text"><strong style="color: #fff;">Are you seeking a cutting-edge solution for leverage and margin trading exchange development? Choose our services to unlock advanced trading software tailored to your specific business needs, delivering exceptional performance and unparalleled customer satisfaction.</p>

                                        <div class="txt">
                                            <a rel="nofollow" href="{{ url('consultation') }}" class="nec-btn" id="cyz"
                                                style="border-radius: 30px !important;">Consult with Our Expert</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12 text-center" style="margin-top: 40px;"> <img
                                class="magic" src="{{ asset('images/leverage/banner-img1.webp') }}" alt=" " title=" "
...
<div class="common_spacing gray_bg">
    <div class="container">
        <div class="section-title text-center">
            <h2 class="title-th sec_tit underline">How Leverage and Margin Trading Impact Crypto Investments</h2>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                <p class="text-center" style="color: #000000">Leverage and margin trading are powerful strategies in today’s crypto market, enabling investors to amplify their profits by trading with more capital than they own. These methods allow traders to borrow cryptocurrency, thereby taking larger positions than their available balance.<br><br>
                    Margin refers to the initial amount of cryptocurrency an investor holds in their account, while leverage represents the multiplier used to open larger positions. For example, with 5 BTC and a 5x leverage, an investor can use leverage and margin trading to control a position worth 25 BTC. These strategies not only enhance trading potential but also make leverage and margin trading platforms highly valued by both current and prospective traders, offering a compelling model for long-term success.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                <img class="lazy" src="{{ asset('images/leverage/img-1.webp') }}">
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 text-left">
                <div class="section-title text-left">
                    <h2 class="title-th sec_tit underline">Strategic Reasons to Launch Leverage and Margin Trading Software</h2>
                </div>
                <p class="text-left" style="color: #000000">
                    Given the current surge in crypto trading models that leverage amplified investments, deploying leverage and margin trading exchange software is a strategic move. As a leading developer in margin trading solutions, we offer exceptional services tailored for those looking to create platforms that deliver maximum user benefits.<br><br>
                    With over a decade of expertise in blockchain technology and a track record of advancing numerous projects using cutting-edge technology, you can rely on our team to guide you. Partner with us for a development approach and final product that sets industry standards.</p>
            </div>
        ...
        <div class="row">
            <div class="section-title text-center">
                <div class="sec_tit mb20">
                    <h2 class="section-title underline mb20">Key Features of Our Crypto Margin Trading Software</h2>
                </div>
                <p style="color: #000000">Elevate your customer's experience with our advanced crypto margin trading software, designed with essential features for a seamless trading journey. Simplify the complexities of cryptocurrency trading through these powerful capabilities:</p>
            </div>
        </div>
        <div class="row mt20 container-center">
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/leverage/icons/currency.webp') }}"></div>
                    <div class="icon_content">
                        <h3>Integrated Multi-Currency Wallet</h3>
                        <p class="c-grey" style="color: #000000">Empower users to manage, trade, and withdraw a wide range of cryptocurrencies and fiat currencies from a single, versatile wallet.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/leverage/icons/admin-panel.png') }}">
                    </div>
                    <div class="icon_content">
                        <h3>Comprehensive Admin Panel</h3>
                        <p class="c-grey" style="color: #000000">Equip platform administrators with a robust control panel to oversee and optimize every aspect of the exchange, ensuring flawless operation.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/leverage/icons/security.png') }}"></div>
                    <div class="icon_content">
                        <h3>Multi-Layered Security</h3>
                        <p class="c-grey" style="color: #000000">Implement extensive security measures to protect users and assets from cyber threats, maintaining the highest standards of safety.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/leverage/icons/trading.png') }}"></div>
                    <div class="icon_content">
                        <h3>Cutting-Edge Trading Engine</h3>
                        <p class="c-grey" style="color: #000000">Deliver a sophisticated trading engine that efficiently processes and executes trades in real-time, providing a smooth user experience.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/leverage/icons/buying.webp') }}"></div>
                    <div class="icon_content">
                        <h3>High Leverage Capabilities</h3>
                        <p class="c-grey" style="color: #000000">Enable users to take advantage of high-leverage positions, maximizing their trading potential and enhancing profit opportunities</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/leverage/icons/order.png') }}"></div>
                    <div class="icon_content">
                        <h3>Diverse Order Types</h3>
                        <p class="c-grey" style="color: #000000">Enrich the trading experience with a variety of order types, including market orders and copy trading options, tailored to meet diverse user needs.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="product-features package_includes" style="background: #fff">
    <div class="container">
        <div class="section-title text-center">
            <div class="sec_tit mb20">
                <h2 class="section-title underline mb20 ">Innovative Features to Enhance Your Crypto Leverage Exchange</h2>
            </div>
            <p class=" " style="color: #000000">Looking to distinguish your crypto leverage trading exchange software in a competitive market? Enhance your platform with these powerful add-on features to achieve outstanding results</p><br>
        </div>
        <div class="col-md-12 text-center">
            <div class="container container-center">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/mobile-game.png') }}"
                            alt="">
                        <h3>Mobile Application</h3> Enable users to access their crypto leverage exchange anytime, anywhere with dedicated mobile apps for both iOS and Android.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/live.png') }}" alt="">
                        <h3>Real-Time Market Data</h3>Equip your platform with live market data, empowering users to make well-informed trading decisions and execute leverage strategies effectively.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/news.png') }}" alt="">
                        <h3>News and Insights</h3>Integrate a system for delivering the latest news and expert insights on the global crypto landscape, helping traders make strategic moves.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/order.png') }}" alt="">
                        <h3> Stop-Loss Orders</h3>Provide users with the ability to set stop-loss orders, allowing them to limit potential losses based on their risk tolerance and mitigate market volatility.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/risk.webp') }}" alt="">
                        <h3>Advanced Risk Management</h3>Protect traders from volatile market conditions with features like limit orders, take profit orders, and margin calls.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/chart.png') }}" alt="">
                        <h3>Market Activity Charts</h3>Offer detailed charts that display the buying and selling activity of various cryptocurrencies, keeping users informed and engaged.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/account.png') }}" alt="">
                        <h3>Demo Account</h3>Allow new users to familiarize themselves with the functionalities of your exchange app through a demo account before engaging in real cryptocurrency trading.
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 equalize">
                    <div class="Package_list" style="color: #000000"> <img class="lazy" src="{{ asset('images/leverage/icons/api.png') }}" alt="">
                        <h3>API Integration</h3>Seamlessly integrate APIs to synchronize your exchange with global market updates, ensuring your platform remains current and efficient.
                    </div>
                </div>
            </div>
        </div>
...
<section class="travel-app" style="background: #e4e9ff;">
    <div class="container">
        <div class="row">

            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="section-title text-left">
                    <h3> <strong>Securing Your Leverage Trading Exchange Development</strong></h3>
                    <hr>
                    <p style="color: #000000">As leaders in developing robust leverage trading exchange solutions worldwide, we prioritize comprehensive security measures at every level. Our advanced, military-grade solutions ensure your users are protected from cyber threats around the clock.</p>
                </div>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="travel-app-items">
                    <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/security.png') }}"></div>
                    <p><strong>System Security</strong>Enforce stringent multi-factor authentication protocols to safeguard user accounts and access.</p>
                </div>
                <div class="travel-app-items">
                    <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/communication.png') }}"></div>
                    <p><strong>Communication Security</strong>Utilize top-tier data encryption to secure all communications and protect sensitive information.</p>
                </div>
                <div class="travel-app-items">
                    <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/wallet.png') }}"></div>
                    <p><strong>Wallet Security</strong>Implement multi-signature withdrawal processes to enhance the security of cryptocurrency holdings and transactions.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="center-align">
    <div class="container">
        <div class="row">
            <div class="section-title text-center">
                <h3> <strong>Incorporating Diverse Margin Trading Modes into Your New Exchange </strong></h3>
                <hr>
            </div>

            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul style="background: #e4e9ff;">
                    <li>
                        <div>
                            <div class="section-title">
                                <h3 class="title"> <span class="red-txt"><strong>Isolated Margin Trading</strong></span>
                                </h3>
                            ...
                            <div class="sub_ff1" style="margin-top: 10px;">
                                ...
                                <p class="dev1" style="color: #000000"><strong> Overview:</strong> Isolated margin trading allows traders to use leverage for multiple positions, each with its own collateral. This isolation ensures that losses from one trade don’t impact others or the initial margin.</p>

                                <i class="fa fa-check" aria-hidden="true"></i>
                                <p class="dev1"><strong> Key Benefits: </strong> </p>

                                <p style="color: #000000" class="dev1" style="padding-left: 30px;"><strong><i class="fa fa-arrow-circle-right"
                                            aria-hidden="true" style="position: relative;"></i> Independent Risk Management:</strong> Traders can set distinct stop-loss and take-profit orders for each position, managing risk on an individual basis.</p>

                                <p style="color: #000000" class="dev1" style="padding-left: 30px;"><strong><i class="fa fa-arrow-circle-right"
                                            aria-hidden="true" style="position: relative;"></i> Dedicated Margin Allocation:</strong> Each trade is assigned a specific margin and collateral, preventing losses in one position from affecting others.</p>

                                <p style="color: #000000" class="dev1" style="padding-left: 30px;"><strong><i class="fa fa-arrow-circle-right"
                                            aria-hidden="true" style="position: relative;"></i> Precise Risk Control:</strong> This approach allows for meticulous control over market exposure for each position, enabling strategic investment management.</p>

                                <i class="fa fa-check" aria-hidden="true"></i>
                                <p style="color: #000000" class="dev1"><strong> Ideal For:</strong> Traders seeking a controlled and precise trading strategy, where they can independently set risk parameters and mitigate losses. </p>
                            </div>
                    ...
                    <li>
                        <div>
                            <div class="section-title">
                                <h3 class="title"> <span class="red-txt"><strong>Cross-Margin Trading</strong></span>
                                </h3>
                                <hr style="margin-left: 0;">
                            </div>
                            ...
                            <div class="sub_ff1" style="margin-top: 10px;">
                                <i class="fa fa-check" aria-hidden="true"></i>
                                <p style="color: #000000" class="dev1"><strong> Overview:</strong> Isolated margin trading allows traders to use leverage for multiple positions, each with its own collateral. This isolation ensures that losses from one trade don’t impact others or the initial margin.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt20">
                <h2 class="sec_tit underline text-center ">Why Choose Our Whitelabel Leverage and Margin Trading Platform</h2>
                <p class="text-center " style="font-size: 16px; color: #000000;">Looking for a streamlined solution to launch your margin crypto trading exchange? Our advanced Whitelabel platform provides unparalleled customization and rapid market deployment, delivering exceptional benefits to your users:</p>
            </div>
            <div align="center" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/trading.png') }}"></div>
                        <p class=" ">Access to Expanded Trading Opportunities</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/profit.png') }}"></div>
                        <p class=" ">Enhanced Profit Potential</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/portfolio.png') }}"></div>
                        <p class=" ">Diversification of Trading Portfolios</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/buy-sell.png') }}"></div>
                        <p class=" ">Effortless Short Selling</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/risk.webp') }}"></div>
                        <p class=" ">Robust Risk Management Features</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/liquidity.webp') }}"></div>
                        <p class=" ">Superior Crypto Liquidity</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/flexibility.png') }}"></div>
                        <p class=" ">Adaptable Trading Strategies</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/transactions.png') }}"></div>
                        <p class=" ">Rapid Transaction Processing</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/access-control.webp') }}"></div>
                        <p class=" ">24/7/365 Market Availability</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/low-fees.webp') }}"></div>
                        <p class=" ">Minimized In-Platform Trading Fees</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/trading-fee.webp') }}"></div>
                        <p class=" ">Broadened Trading Choices</p>
                    </li>
                    <li>
                        <div class="icons"><img class="lazy" src="{{ asset('images/leverage/icons/support.png') }}"></div>
                        <p class=" ">Global Community Engagement</p>
                    </li>
                </ul>
            </div>
        </div>
...
<div id="our_services" class="defisec ">
    <div class="container">
        <div class="section-title text-center">
            <h3 class="common_h3 title-th sec_tit">Advanced Risk Management Features in Our Whitelabel Margin Trading Platform</h3>
            <hr>
            <p style="color: #000000;">Concerned about significant losses from market volatility affecting your traders? Our Whitelabel margin trading exchange solutions incorporate robust risk management tools to safeguard users' investments.</p><br>
        </div>
        <div class="grids">
            <div class="grid col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="feature-box-3">
                    <div class="icon"> <img src="{{ asset('images/leverage/icons/investors.png') }}" alt="" class="lazy"
                            width="45px;"> </div>
                    <h4 class="feature-title common_h4">Automatic Deleveraging (ADL)</h4>
                    <p class="feature-desc mb0">Automatically liquidates positions when cryptocurrency prices hit critical levels, minimizing losses.</p>
                </div>
            </div>
            <div class="grid col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="feature-box-3">
                    <div class="icon"><img src="{{ asset('images/leverage/icons/profit.png') }}" alt="" class="lazy"
                            width="45px;"> </div>
                    <h4 class="feature-title common_h4">Stop Loss/Take Profit Orders</h4>
                    <p class="feature-desc mb0">Enables traders to set predefined thresholds for automatic exit, optimizing returns.</p>
                </div>
            </div>
            <div class="grid col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="feature-box-3">
                    <div class="icon"> <img src="{{ asset('images/leverage/icons/support.png') }}" alt="" class="lazy"
                            width="45px;"></div>
                    <h4 class="feature-title common_h4">Partial Close Functionality</h4>
                    <p class="feature-desc mb0">Lets users close a portion of their trades while continuing to benefit from favorable market conditions.</p>
                </div>
            </div>
            <div class="grid col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="feature-box-3">
                    <div class="icon"> <img src="{{ asset('images/leverage/icons/insurance.png') }}" alt="" class="lazy"
                            width="45px;"></div>
                    <h4 class="feature-title common_h4">Crypto Insurance Funds</h4>
                    <p class="feature-desc mb0">Shields investors by providing insurance to prevent liquidation, even if positions fall below margin requirements.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-title text-center">
                        <h3 class="font-wei mb20">Why Choose Us for Your Margin Trading Exchange Development</h3>
                        <hr>
                    </div>
                    <p style="color: #000000;">We excel in delivering top-tier leverage and margin trading exchange solutions tailored to the needs of both businesses and their users. Our comprehensive approach has established us as a leading choice for margin trading development, trusted by numerous crypto entrepreneurs worldwide. Partner with us to elevate your crypto trading platform with our expertise.</p>
                </div>
            </div>
            <div class="row md-flex">
                <div class="col-md-5 col-sm-12 col-md-12 col-md-offset-1">
                    <ul style="color: #000000;">
                        <li><strong>Custom Development:</strong> We create solutions specifically designed to meet the unique needs of each project.</li>
                        <li><strong>Experienced Marketing Team:</strong> Our skilled in-house marketing professionals enhance the technical excellence of your platform.</li>
                        <li><strong>High-Quality Services:</strong> We offer a full range of premium services without compromise.</li>
                    </ul>
                </div>
                <div class="col-md-5 col-sm-12 col-md-12 col-md-offset-1">
                    <ul style="color: #000000;">
                        <li><strong>Proven Track Record:</strong> Our extensive portfolio includes numerous successful crypto and web ventures.</li>
                        <li><strong>Transparent Communication:</strong> We maintain an open and consistent dialogue with clients throughout the development process.</li>
                        <li><strong>Global Clientele:</strong> Our diverse international client base reflects our reputation and expertise in the industry.</li>
                    </ul>
                </div>
    ...
    <div class="container">
        <div class="col-lg-12 center">
            <div class="section-title text-center m-b-30">
                <h3 class="common_h3 sec-tit">Cutting-Edge Technologies Behind Our Crypto Leverage Trading Exchange Software</h3>
                <hr>
                <p style="color: #000000;">Harness our expertise in deploying the latest and most powerful technologies to launch your crypto leverage trading exchange with unmatched efficiency and seamless performance. Our team continuously updates its skills to stay ahead of technological advancements. Reach out today to discuss any specific tech needs you may have!</p>
            </div>
        </div>
...
@include('static.simple-faqs-section', [
    'faqs' => [
        [
            'ques' => 'What is Leverage and Margin Trading Exchange Software?',
            'ans' => "Leverage and margin trading exchange software enables users to trade with borrowed funds, allowing them to open larger positions than their account balance. It facilitates both high-risk, high-reward strategies and more extensive market exposure."
        ],
        [
            'ques' => 'How Does Crypto Leverage Trading Software Benefit Users?',
            'ans' => "This software provides users with the ability to amplify their trading positions and potential profits by using leverage. It enhances trading flexibility and allows for more substantial market engagement, boosting opportunities for significant gains."
        ],
        [
            'ques' => 'What Types of Trades Can Be Executed in Crypto Margin Trading Software?',
            'ans' => "Crypto margin trading software supports various trade types, including market orders, limit orders, and stop orders. It also offers advanced options like short selling and leveraged positions, accommodating diverse trading strategies."
        ],
        [
            'ques' => 'What Is the Cost of Developing Leverage and Margin Trading Exchange Software?',
            'ans' => "The cost of development depends on various factors such as complexity, features, and technology stack. Custom solutions typically involve higher costs due to tailored features, while standard solutions may be more affordable."
        ],
        [
            'ques' => 'Which Company Offers the Best Leverage Trading Exchange Development?',
            'ans' => "The best company for leverage trading exchange development is one with a proven track record, extensive experience, and a strong portfolio of successful projects. Look for a provider that delivers both technical expertise and innovative solutions tailored to your needs."
        ],
    ],
])
</div>
<script src="js/jquery.min.js" type="693504d55a0ae806a0a85abd-text/javascript"></script>
<script type="693504d55a0ae806a0a85abd-text/javascript">
...
<script src="js/vendor.js" type="693504d55a0ae806a0a85abd-text/javascript"></script>
<script src="js/plugins.js" type="693504d55a0ae806a0a85abd-text/javascript"></script>
<script src="js/main.js" type="693504d55a0ae806a0a85abd-text/javascript"></script>
<script src="build/js/intlTelInput.js" type="693504d55a0ae806a0a85abd-text/javascript"></script>
<script type="693504d55a0ae806a0a85abd-text/javascript">
        ...
        <form class="form-side" id="mailForm_sticky" method="post" action="">
            ...
            <div class="form-group">
                ...
                <input id="phone_sticky" name="phone_dummy" type="text" required=""
                    ...
                    data-cf-modified-693504d55a0ae806a0a85abd-="">
                <input type="hidden" name="phone" id="phone_newsletter">
                <input type="hidden" name="url" id="url" value="/leverage-margin-trading-exchange">
            </div>
...
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="693504d55a0ae806a0a85abd-|49" defer></script>
</div>
