@extends('layouts.static')
    @section('title', 'Binance Clone Software')
...
<style type="text/css">
    ...
    <style type="text/css">.teck .category-icon img {
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="contentall">
                                <div class="ovr">
                                    <div itemscope itemtype="http://schema.org/CreativeWork">
                                        <div class="ban_tirt">
                                            <h1 itemprop="name">Unlock the Power of Binance with Our State-of-the-Art
                                                Clone Solution</h1>
                                        </div>
                                        <p itemprop="text">Launch your own cryptocurrency exchange inspired by Binance
                                            using our cutting-edge Binance Clone Software. Experience the speed and
                                            efficiency of the Binance platform while enjoying a fully customized
                                            solution tailored to your needs.</p>
                                        <div class="txt">
                                            <a href="{{ url('consultation') }}" class="nec-btn" id="cyz"
                                                style="border-radius: 30px !important;">Consult with Our Experts Request
                                                a Demo</a>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 text-center"> <img class="magic"
                                src="{{ asset('images/binance-clone/banner-img.webp') }}" alt=" " title=" "> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="common_spacing gray_bg">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="title-th sec_tit underline">Build a Premier Crypto Exchange with Our Advanced Binance
                        Clone</h2>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <p class="text-center">In the dynamic world of cryptocurrency, Binance stands out as a leading
                            platform in the decentralized economy. By leveraging our robust Whitelabel software to
                            create a Binance-inspired exchange, you can position yourself at the forefront of the crypto
                            market. Binance's success stems from its efficient use of a sophisticated ecosystem of
                            parallel blockchains.<br><br>
                            Adopting a Binance-like exchange can deliver significant advantages in user experience and
                            operational efficiency. Harness the power of the Binance ecosystem to facilitate swift
                            transactions and minimize operational costs.</p>
                    </div>
                    <div class="text-center cta_mine txt">
                        <a href="{{ url('consultation') }}"
                            class="nectar-button medium regular accent-color regular-button nec-btn med-btn"><span>Connect
...
@include('static.step1',array(
   'title' => 'How Our Binance Clone Operates', 
   'desc' => 'Our Binance clone offers a streamlined and intuitive interface designed to provide exceptional user experiences. The process is straightforward, ensuring ease of use for all traders.',
   'card_title_1' => 'User Registration',
   'card_desc_1' => 'Begin by registering on the platform using either an email address or wallet public address.',
   'card_title_2' => 'Market Insights',
   'card_desc_2' => 'Users can access comprehensive market charts and current news to track pricing trends before making any trades.',
   'card_title_3' => 'Advanced Analytics',
   'card_desc_3' => 'Utilize built-in analytical tools to forecast price movements and make informed decisions about cryptocurrency holdings.',
   'card_title_4' => 'Seamless Trading',
   'card_desc_4' => 'When ready to sell, the platform efficiently matches orders with potential buyers to facilitate smooth transactions.',
   'card_title_5' => 'Staking Opportunities',
   'card_desc_5' => "Users can earn passive income by staking their crypto assets in the Binance clone's staking pools.",
   'card_title_6' => 'Fiat Transactions',
   'card_desc_6' => "Purchase any cryptocurrency with fiat currency, ensuring you have sufficient BNB to cover transaction fees.",
   'cta_text' => '',
   'cta_link' => ''
))
...
@include('static.six-card-section', [
    'title' => 'Core Features of Our Binance Clone Development', 
    'desc' => "Our Binance clone development team is committed to creating user-focused crypto solutions to ensure long-term relevance and success. Integrate industry-leading features into your Binance-inspired crypto exchange to attract and engage millions of crypto enthusiasts!",
    'cards' => [
        [
            'title' => 'Seamless Signup',
            'desc' => "Users can effortlessly register and access the Binance clone app using crypto wallets or email, with robust security measures like two-factor authentication.",
            'image' => 'binance-clone/icons/signup.webp'
        ],
        [
            'title' => 'Efficient User Verification',
            'desc' => "The platform incorporates advanced KYC and AML protocols for swift and secure user verification, ensuring a trustworthy environment.",
            'image' => "binance-clone/icons/verification.webp"
        ],
        [
            'title' => "Integrated Wallet",
            'desc' => "Users benefit from a secure, built-in wallet for buying, trading, and holding cryptocurrencies, with easy asset access.",
            'image' => 'binance-clone/icons/wallet.png'
        ],
        [
            'title' => "Versatile Wallet Options",
            'desc' => "Our clone offers flexible wallet functionalities, allowing users to switch smoothly between hot (online) and cold (offline) storage.",
            'image' => 'binance-clone/icons/security.png'
        ],
        [
            'title' => "Advanced Analytical Tools",
            'desc' => "Users gain access to up-to-date market pricing and news, empowering them to make well-informed trading decisions.",
            'image' => 'binance-clone/icons/analytical-reports.webp'
        ],
        [
            'title' => "Trader APIs",
            'desc' => "The clone features robust APIs for traders, facilitating the creation and management of automated trading strategies, custom data analysis, and more.",
            'image' => 'binance-clone/icons/trader.png'
        ],
        [
            'title' => "Admin Dashboard",
            'desc' => "Administrators can efficiently oversee and control transaction data, listing requests, support tickets, and user feedback through a centralized management interface, ensuring prompt and effective action.",
            'image' => 'binance-clone/icons/admin-panel.png'
        ],
        [
            'title' => "Project Launchpad",
            'desc' => "New Web3 ventures can leverage the integrated launchpad feature on our Binance clone platform to achieve substantial market exposure and secure vital funding through initial offerings.",
            'image' => 'binance-clone/icons/launchpads.webp'
        ],
    ],
])
...
@include('static.small-round-card-section',array(
   'title' => 'Exceptional Advantages of Our Binance Clone App Development', 
   'desc' => 'Elevate user experience with our advanced Binance clone app development, delivering unparalleled benefits to crypto enthusiasts of all levels.',
   'card_title_1' => 'Diverse Trading Options',
   'card_desc_1' => 'Offer a wide range of trading options tailored to novice and expert traders, accommodating various risk profiles.',
   'card_image_1' => 'binance-clone/icons/trading.png',
   'card_title_2' => 'Reduced Fees',
   'card_desc_2' => 'Benefit from minimized transaction fees, thanks to the cost-efficient nature of the Binance blockchain ecosystem.',
   'card_image_2' => 'binance-clone/icons/low-fees.webp',
   'card_title_3' => 'KYC-Based Limits',
   'card_desc_3' => "Enable transactions with adjustable limits based on users' KYC verification levels, ensuring secure and compliant trading.",
   'card_image_3' => 'binance-clone/icons/kyc.png',
   'card_title_4' => 'Broad Range of Trading Pairs',
   'card_desc_4' => 'Access a vast array of cryptocurrency pairs seamlessly, facilitating effortless trades on your Binance-inspired platform.',
   'card_image_4' => 'binance-clone/icons/trade.svg',
   'card_title_5' => 'Cross-Platform Accessibility',
   'card_desc_5' => 'Ensure your Binance clone app functions flawlessly across multiple devices, including browsers, computers, and smartphones.',
   'card_image_5' => 'binance-clone/icons/cross-chain.webp',
   'card_title_6' => 'Multiple Payment Gateways',
   'card_desc_6' => 'Support transactions through diverse payment methods via a streamlined payment interface, including cryptocurrencies and credit/debit cards.',
   'card_image_6' => 'binance-clone/icons/payment-gateways.png',
   'card_title_7' => 'Rapid Transactions',
   'card_desc_7' => "Experience swift in-app transactions, capitalizing on the high throughput capabilities of the Binance blockchain infrastructure.",
   'card_image_7' => 'binance-clone/icons/transactions.png',
   'card_title_8' => 'Guaranteed Liquidity',
   'card_desc_8' => 'Enjoy reliable liquidity for all listed cryptocurrencies, driven by extensive liquidity pools within the exchange.',
   'card_image_8' => 'binance-clone/icons/liquidity.webp',
))
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <h3 class="text-white">Ready to Launch Your Crypto Exchange on a Cutting-Edge Blockchain?</h3>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="text-center">
                    <div class="cta_mine">
                        ...
                        <a rel="nofollow" href="{{ url('consultation') }}"
                            class="nectar-button medium regular accent-color regular-button nec-btn"><span>Connect with our specialists today</span></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="common_spacing gray_bg">
    <div class="container">
        <div class="row">
            <h3 class="sec_tit underline text-center" style="width: 100%">Enhanced Features for Your Binance Clone</h3>
        </div>
        <p class="text-center" style="color: #000;">Elevate your Binance clone app with our advanced add-on modules to stand out in the competitive crypto market. These powerful features will take your exchange to the next level, delivering unparalleled value.</p>
        <div class="row mt40">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 m-auto equalize">
                    <div class="cmt-bgcolor-white featured-icon-box icon-align-top-content text-left style3">
                            ...
                            <div
                                ...
                                <i class="flaticon flaticon-air-freight">
                                    <img class="img-fuild lazy" style="width: 65px !important; height:65px !important;"
                                        src="{{ asset('images/binance-clone/icons/nft.webp') }}" alt>
                                </i> </div>
                        </div>
                        <div class="featured-content">
                            ...
                            <div class="featured-desc">Integrate a dedicated NFT marketplace into your exchange to tap into the booming NFT sector, providing a dynamic space for crypto traders, collectors, and creators to engage and transact.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 m-auto equalize">
                    <div class="featured-icon-box  text-left style3">
                        <div class="featured-icon">
                            <div
                                ...
                                <i class="flaticon flaticon-air-freight">
                                    <img class="img-fuild lazy" style="width: 65px !important; height:65px !important;"
                                        src="{{ asset('images/binance-clone/icons/crypto.png') }}" alt>
                                </i> </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                                <h3>Crypto Loan Services</h3>
                            </div>
                            <div class="featured-desc">Incorporate crypto loan facilities into your platform, allowing users to earn additional income through interest by lending their assets to those in need of capital.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 m-auto equalize">
                    <div class="cmt-bgcolor-white featured-icon-box icon-align-top-content text-left style3">
                        <div class="featured-icon">
                            <div
                                ...
                                <i class="flaticon flaticon-air-freight">
                                    <img class="img-fuild lazy" style="width: 65px !important; height:65px !important;"
                                        src="{{ asset('images/binance-clone/icons/feedback.svg') }}" alt>
                                </i> </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                            ...
                            <div class="featured-desc">Embed social feeds within your exchange to keep users updated with the latest global crypto news, helping them make informed decisions about their investments.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 m-auto equalize">
                    <div class="cmt-bgcolor-white featured-icon-box icon-align-top-content text-left style3">
                        <div class="featured-icon">
                            <div
                                ...
                                <i class="flaticon flaticon-air-freight">
                                    <img class="img-fuild lazy" style="width: 65px !important; height:65px !important;"
                                        src="{{ asset('images/binance-clone/icons/ads.webp') }}" alt>
                                </i> </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                                <h3>Advertising Portals</h3>
                            </div>
                            <div class="featured-desc">Enable crypto projects to advertise directly on your platform, creating a win-win scenario by generating additional revenue for your exchange and increasing visibility for these projects.</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt20">
            <div class="section-title text-center">
                <div class="sec_tit mb20">
                    <h2 class="section-title underline mb20">AI-Driven Binance Clone Solutions for Modern Exchanges</h2>
                </div>

                <p>Unlock the full potential of your crypto exchange with our Binance clone development team’s expertise in integrating artificial intelligence. Our advanced AI solutions empower your platform with cutting-edge technology, elevating both operational efficiency and user experience.</p>
            </div>
        </div>
        <div class="row mt20 container-center">
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/binance-clone/icons/automated.webp') }}">
                    </div>
                    <div class="icon_content">
                        <h3>Automated Processes</h3>
                        <p class="c-grey">Streamline your crypto exchange with AI-driven automation for tasks like order matching and transaction processing, enhancing operational efficiency and customer satisfaction.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/binance-clone/icons/time.png') }}"></div>
                    <div class="icon_content">
                        <h3>Real-Time Market Insights</h3>
                        <p class="c-grey">Equip your users with the latest market data through AI-powered aggregation systems that analyze and deliver information tailored to their trading preferences.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/binance-clone/icons/analytics.png') }}">
                    </div>
                    <div class="icon_content">
                        <h3>Sophisticated Analytics</h3>
                        <p class="c-grey">Provide users with advanced AI tools for deep market analysis and predictive insights, enabling them to make informed investment decisions with real-time data.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 equalize">
                <div class="icon-text-1">
                    <div class="icon-text-icon"><img class="lazy" src="{{ asset('images/binance-clone/icons/security.png') }}">
                    </div>
                    <div class="icon_content">
                        <h3>Top-Tier Security</h3>
                        <p class="c-grey">Protect your users with AI-based security measures that proactively identify and address potential threats, ensuring a secure trading environment.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="technologies gray_bg" style="background:#eee;">
    <div class="container">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3 class="sec_tit underline text-center">Why Our Binance Clone is the Premier Choice for Your Business</h3>
            <p class="text-center " style="font-size: 16px;">Choosing our Binance clone is your gateway to dominating the cryptocurrency exchange market. With unparalleled customization, cutting-edge security features, and a powerful blockchain foundation, your platform will captivate every crypto enthusiast.</p>
            <ul>
                <li>
                    <img class="lazy" src="{{ asset('images/binance-clone/icons/consultation.png') }}">
                    <p class="white">Expert Guidance </p>
                </li>
                <li>
                    <img class="lazy" src="{{ asset('images/binance-clone/icons/customize.webp') }}">
                    <p class="white">Highly Adaptable</p>
                </li>
                <li>
                    <img class="lazy" src="{{ asset('images/binance-clone/icons/safe-storage.webp') }}">
                    <p class="white">Unmatched Security</p>
                </li>
                <li>
                    <img class="lazy" src="{{ asset('images/binance-clone/icons/pricing.png') }}">
                    <p class="white">Cost-Effective Solutions</p>
                </li>
                <li>
                    <img class="lazy" src="{{ asset('images/binance-clone/icons/support.png') }}">
                    <p class="white">Ongoing Support</p>
                </li>
                <li>
                    <img class="lazy" src="{{ asset('images/binance-clone/icons/time.png') }}">
                    <p class="white">Rapid Deployment</p>
                </li>
            </ul>
        </div>
    </div>
...
<section class="space-pt bg-dark-half-md tech-padding teck">
    <div class="container">
        <div class="row justify-content-md-center text-center">
            <div class="section-title text-center ">
                <h3 class="sec_tit underline text-center">What is the Investment Required to Develop a Binance Clone?</h3>
                <p class="section-subtitle ">Unlock the potential of your crypto exchange with our Binance clone at competitive rates tailored to your specific needs. The cost is influenced by the unique requirements of your business, encompassing</p>
            </div>
        </div>
        <div class="row mt20">
            <div class="col-sm-12">
                <div class="category category-grid-style-01 aos-item aos-init" data-aos="fade-up"
                    ...
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/visual.svg') }}" alt=" "> </div>Visual Customization
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/user.png') }}" alt=" "> </div>User Experience Features
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/blockchain.webp') }}" alt=" "> </div>Blockchain Integration
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/infrastructure.png') }}" alt=" "> </div>Infrastructure Needs
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/security.png') }}" alt=" "> </div>Advanced Security
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/api.png') }}" alt=" "> </div>Third-party API Connections
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/integration.png') }}" alt=" "> </div>Integration Requirements
                    </div>
                    <div class="category-item aos-item">
                        <div class="category-icon"> <img class="img-fuild lazy" width="auto" height="40px"
                                src="{{ asset('images/binance-clone/icons/maintenance.png') }}" alt=" "> </div>Ongoing Maintenance
                    </div>
...
<div class="common_spacing" style="background:#140050;">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="section-title text-center">
                    <h3 class="text-white">Why Partner with Us for Your Binance Clone Exchange Launch?</h3>
                    <hr class="mb40">
                    <p class="text-white">We are committed to propelling ambitious ventures to the forefront with our cutting-edge solutions. Our Binance clone stands as a premier platform for new crypto exchanges, ensuring unparalleled success. From inception to post-launch, our dedicated team will provide exceptional support and value for your investment. Reach out to our experts to initiate your crypto exchange launch with our advanced Binance clone.</p>
                    ...
                    <div class="contentall" align="center" style="padding-top: 0px;">
                        ...
                        <a href="{{ url('consultation') }}" rel="nofollow"
                            style="border-radius: 30px !important; text-transform:none !important;">Connect with Our Specialists</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h5 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        href="#faq1">
                                        <span>Why Should You Choose Our Binance Clone?</span>
                                    </a>
                                </h5>
                            </div>
                            <div id="faq1" class="panel-collapse collapse in" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <p>You should choose our Binance clone to offer your customers the best experience
                                        as a business in all aspects – features, security, and infrastructure.</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h5 class="panel-title">
                                    <a class="" role="button" data-toggle="collapse" data-parent="#accordion"
                                        href="#faq6">
                                        <span>How Much Does It Cost to Clone the Binance Exchange?</span>
                                    </a>
                                </h5>
                            </div>
                            <div id="faq6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    The cost to clone the Binance exchange’s model depends on the customization level
                                    you need and the add-on security and user features you want to include.
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h5 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        href="#faq2">
                                        <span>How Does the Binance Clone Platform Work? </span>
                                    </a>
                                </h5>
                            </div>
                            <div id="faq2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    The Binance clone platform works exactly like the original Binance exchange, which
                                    is well known for its extensively user-friendly interface and fiat ramps.
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h5 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        href="#faq3">
                                        <span>What are the Advantages of the Binance Clone App?</span>
                                    </a>
                                </h5>
                            </div>
                            <div id="faq3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    Some advantages of the Binance clone app include various crypto trading options,
                                    cross-platform support, low fees, assured liquidity, and multi-payment gateways.
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h5 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        href="#faq4">
                                        <span>How Long Will It Take to Develop the Binance Clone Software?</span>
                                    </a>
                                </h5>
                            </div>
                            <div id="faq4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <p>We can develop your exchange from Binance clone software within seven days with
                                        all customizations, add-on elements, and API integrations you need.</p>
                                </div>
                            </div>
                        </div>
...
@include('static.simple-faqs-section', [
    'faqs' => [
        [
            'ques' => 'What Makes Our Binance Clone the Ideal Choice?',
            'ans' => "Our Binance clone offers superior customization, robust security, and advanced blockchain technology, ensuring a compelling and secure platform for your crypto exchange. With expert support from start to finish, it’s designed to maximize your success in the crypto market."
        ],
        [
            'ques' => 'What Is the Cost to Develop a Binance Clone?',
            'ans' => "The cost of developing a Binance clone varies based on factors like customization, features, and integration needs. Each project is unique, so the final cost will depend on your specific requirements and the complexity of the development."
        ],
        [
            'ques' => 'How Does the Binance Clone Platform Operate?',
            'ans' => "Our Binance clone functions similarly to the original Binance platform, providing a seamless experience for users to trade cryptocurrencies. It integrates advanced features for trading, security, and user management, ensuring a high-performance environment."
        ],
        [
            'ques' => 'What Are the Benefits of Using the Binance Clone App?',
            'ans' => "The Binance clone app offers multiple advantages, including customizable trading features, lower operational costs, high security, and a user-friendly interface. It allows you to tap into the proven success of Binance while adapting the platform to your specific needs."
        ],
        [
            'ques' => 'What Is the Development Timeline for the Binance Clone Software?',
            'ans' => "The development timeline for the Binance clone software depends on the complexity of your requirements and customizations. Generally, the process is streamlined to ensure a prompt launch, with timelines provided after assessing your specific project details."
        ],
    ],
])

</div>
<script src="js/jquery.min.js" type="e3b10bb56dc2be36cde0cf46-text/javascript"></script>
<script type="e3b10bb56dc2be36cde0cf46-text/javascript">
...
<script src="js/vendor.js" type="e3b10bb56dc2be36cde0cf46-text/javascript"></script>
<script src="js/plugins.js" type="e3b10bb56dc2be36cde0cf46-text/javascript"></script>
<script src="js/main.js" type="e3b10bb56dc2be36cde0cf46-text/javascript"></script>
<script src="build/js/intlTelInput.js" type="e3b10bb56dc2be36cde0cf46-text/javascript"></script>
<script type="e3b10bb56dc2be36cde0cf46-text/javascript">
        ...
        <form class="form-side" id="mailForm_sticky" method="post" action="">
            ...
            <div class="form-group">
                ...
                <input id="phone_sticky" name="phone_dummy" type="text" required=""
                    ...
                    data-cf-modified-e3b10bb56dc2be36cde0cf46-="">
                <input type="hidden" name="phone" id="phone_newsletter">
                <input type="hidden" name="url" id="url" value="/binance-clone">
            </div>
...
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="e3b10bb56dc2be36cde0cf46-|49" defer></script>
</div>
