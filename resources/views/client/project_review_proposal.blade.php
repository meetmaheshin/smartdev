                                    ...
                                    <div class="col-lg-3 ps-lg-0">
                                        <div class="view_job_right_block view_job_edit_btn p-4">
                                            <ul class="list-unstyled mb-0">
                                                <li class="py-1">
                                                    <i class="fa-solid fa-pen fas color_green font_14"></i>
                                                    <a href="{{route('project.review.view',['id'=>$project_id])}}" class="text-decoration-none color_green font_weight_500 font_14">Edit posting</a>
                                                </li>
                                ...
                                <div class="proposal_applicants_header">
                                    <nav class="proposal_applicants_nav_tabbing">
                                        <div class="nav nav-tabs mb-4 ps-4" id="nav-tab" role="tablist">
                                            <button class="active color_grey font_14 me-3 py-2" id="nav-search-tab" data-bs-toggle="tab" data-bs-target="#nav-search" type="button" role="tab" aria-controls="nav-search" aria-selected="true">Freelancers</button>
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="proposal_user_intro w-100">
                                                    <div class="proposal_user_head_block d-flex align-items-center">
                                                        ...
                                                        <div class="proposal_user_btn d-none d-md-flex ms-auto">
                                                            ...
                                                            <button type="button" class="invited_btn open_btn font_weight_600 font-15 text-decoration-none mx-2 text-muted" disabled>
                                                                <i class="fas fa-check"></i> Accepted Interview</button>
                                                            @elseif($invite->conv_status->status == 2)

                                                            <button type="button" class="invited_btn open_btn font_weight_600 font-15 text-decoration-none mx-2 text-muted" disabled>
                                                                <i class="fas fa-check"></i> Declined Interview</button>

                                                            @elseif($invite->conv_status->status == 3)
                                                            <button type="button" class="invited_btn open_btn font_weight_600 font-15 text-decoration-none mx-2 text-muted" disabled>
                                        ...
                                        <div class="tab-pane fade" id="nav-invited-freelancer" role="tabpanel" aria-labelledby="nav-invited-freelancer-tab">
                                            ...
                                            <div class="proposal_item px-4 d-flex py-4">
                                                <div class="me-3 d-none d-md-block">
                                                    <img class="rounded-circle" src="{{$invites->getInvitedUser->profile_photo_path ? asset('/storage/images/client_profile/'.$invites->getInvitedUser->profile_photo_path) : asset('/images/user_default.jpeg')}}" alt="user-image">
                                                </div>
                                                <div class="proposal_user_intro w-100">
                                                    <div class="proposal_user_head_block d-flex align-items-center">
                                                        <div class="me-3 d-block d-md-none">
                                                        ...
                                                        <div>
                                                            <div class="proposal_user_name">
                                                                <h5 class="color_green font_weight_600 freelancer_details_show" data-bs-toggle="modal" data-bs-target="#sideModal" data-action="{{route('search.details')}}" data-id="{{$invites->getInvitedUser->id}}">
                                                                    {{ $invites->getInvitedUser->full_name ?? ''}}
                                                                </h5>
                                                            </div>
                                                            <div class="proposal_user_des">
                                                                <h6 class="color_black font_14 font_weight_500 me-3">
                                                                    {{ $invites->getInvitedfreelancerProfile->title ?? '' }}
                                                                </h6>
                                                            </div>
                                                            <div class="proposal_user_place">
                                                                <p class="color_grey font_14 m-0">{{ $invites->getInvitedUser->country->name ?? '' }}</p>
                                                            </div>
                                                        </div>
                                                        <div class="proposal_user_btn d-none d-md-flex ms-auto">
                                                            <!-- Button trigger modal -->
                                                            ...
                                                            @elseif($invites->status == 1)
                                                            <a href="{{route('send.offer.view',['userId' => $invites->getInvitedUser->id , 'projectId' => $project_id])}}" class="font_weight_600 up_green_btn text-decoration-none">Hire</a>

                                                            <button type="button" class="invited_btn open_btn font_weight_600 font-15 text-decoration-none mx-2 text-muted" disabled>
                                                                <i class="fas fa-check"></i> Accepted Interview</button>
                                                            @elseif($invites->status == 2)

                                                            <button type="button" class="invited_btn open_btn font_weight_600 font-15 text-decoration-none mx-2 text-muted" disabled>
                                                                <i class="fas fa-check"></i> Declined Interview</button>

                                                            @elseif($invites->status == 3)
                                                            <button type="button" class="invited_btn open_btn font_weight_600 font-15 text-decoration-none mx-2 text-muted" disabled>
                                                                <i class="fas fa-check"></i> Hired
                                                            </button>
                                                            @endif
                                                    ...
                                                    <div class="freelancer-title-rate d-flex align-items-center mb-2 mt-3">
                                                        <p class="color_black font_14 font_weight_500 m-0">${{ $invites->getInvitedfreelancerRate->hourly_rate ?? 0 }}</p>
                                                        <span>/hr</span>
                                                    </div>
                                                    <div class="proposal_user_message_box">
                                                        <div class="">
                                                            <p class="font_14 color_black m-0">Has <span class="font_weight_500">{{$invites ? $invites->getInvitedfreelancerSkills->count() : '0' }} relevant
                                                                    skills</span> to your job </p>
                                                        </div>
                                                        <div class="proposal_user_badgets d-flex font_12 pt-3">
                                                            @if(isset($invites))
                                                            @if(count($invites->getInvitedfreelancerSkills)>0)
                                                            @foreach ($invites->getInvitedfreelancerSkills as $skills)
                                                            <span>{{ $skills->skill->skills_sub }}</span>
                                                            @endforeach
                                                            @endif
                                                            @endif
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="nav-proposals" role="tabpanel" aria-labelledby="nav-proposals-tab">
                                            ...
                                            <div class="proposal_item px-4 d-flex py-4" data-id="{{$prop->id}}">
                                                ...
                                                <div class="hire_job">
                                                    @if($prop->status == 0)
                                                    <a href="{{route('send.offer.view.review',['userId' => $prop->user_id , 'projectId' => $prop->project_id])}}" class="font_weight_600 up_green_btn text-decoration-none">Hire</a>
                                                    @endif
                                                </div>
                                            </div>
                                            @endif
                                        ...
                                        <div class="tab-pane fade" id="nav-shortlisted" role="tabpanel" aria-labelledby="nav-shortlisted-tab">
                                            ...
                                            <div class="proposal_item px-4 d-flex py-4" data-id="{{$list->id}}">
                                                <div class="proposal_user_img_block me-5 d-none d-lg-block">
                                                    <div class="user_img">
                                                ...
                                                <div class="proposal_user_intro">
                                                    <div class="proposal_user_head_block d-flex justify-content-lg-between align-items-center">
                                                        <div class="d-lg-none user_mobile_img me-3">
                                                            <img class="rounded-circle" src="{{$list->users->profile_photo_path ? asset('/storage/images/client_profile/'.$list->users->profile_photo_path) : asset('/images/user_default.jpeg')}}" alt="img">
                                                        </div>
                                                        <div>
                                                            <div class="proposal_user_name">
                                                                <h5 class="color_green font_14 font_weight_600">{{$list->users->full_name}}</h5>
                                                            </div>
                                                            <div class="proposal_user_des">
                                                                <h6 class="color_black font_14 font_weight_500 me-3">{{$list->users->FreelancerProfile->title ?? ''}}</h6>
                                                            </div>
                                                            <div class="proposal_user_place">
                                                                <p class="color_grey font_14 m-0">{{$list->users->country->name ?? ''}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="profile-stats font_14 color_black d-flex justify-content-between align-items-center flex-wrap my-3 my-md-2">
                                                        <div class="">
                                                            <span class="font_weight_500">${{$list->users->freelancerRate->hourly_rate ?? ''}}</span>
                                                            <span>/hr</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="proposal_user_message_box">
                                                    ...
                                                    <div class="cover_letter color_black font_12">
                                                        <strong>Cover letter -</strong>
                                                        <span class="text-break">{{$list->cover_letter ?? ''}}</span>
                                                    </div>
                                                    <div class="proposal_user_badgets d-flex font_12 pt-3 flex-wrap">
                                                        @foreach($list->users->freelancerSkills as $value)
