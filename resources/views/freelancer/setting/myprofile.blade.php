        			...
        			<div class="profile_description mb-5">
        				<div class="d-flex justify-content-between mb-4">
        					<div class="d-flex align-items-center">
        						...
        						<a href="javascript:void(0)" class="icon_color font_12" data-bs-toggle="modal" data-bs-target="#edit_title">
        				...
        				<div class="profile_description_content position-relative">	            					
        						<p class="mb-0 pe-5">{{auth()->user()->FreelancerProfile->bio ?? '-'}}</p>	
        						<div class="position-absolute add_description_poppu">
        							<a href="javascript:void(0)" class="icon_color font_12" data-bs-toggle="modal" data-bs-target="#add_description">
          							<i class="fas fa-pencil-alt"></i> 
          						</a>
        						</div>            					
        				</div>
  ...
  <form class="w-100" id="profile_certification" data-action="{{route('myprofile.certification')}}" action="{{route('myprofile.certification')}}" method="POST">	
	@csrf
		<div class="modal-content ">
			<div class="modal-body">
				<div class="d-flex justify-content-between mb-4">
					<div><h3 class="font_24 font_weight_700"> Add certification </h3> </div>
					<div><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
				</div>
				<div class="">        	
			...
			<div class="modal-footer">
				<button type="button" class="btn " data-bs-dismiss="modal">Cancel</button>
				<button type="submit" class="custom_btn">Add certification</button>
			</div>
		</div>
	</form>
  </div>
