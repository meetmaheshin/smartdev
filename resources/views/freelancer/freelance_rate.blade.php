    ...
    <div class="row">
        <form action="{{route('store_rate')}}" method="post">
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <p class="mt-3 mb-5 text-muted font_14">Clients will see this rate on your profile and in search results once you publish your profile. You can adjust your rate every time you submit a proposal.</p>
                <div class="row">
                    <div class="col-md-7">
                        <strong>Hourly Rate</strong>
                        <div class="text-muted font_12">Total amount the client will see</div>
                    </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="text-muted font_12">The Service Fee is 20% when you begin a contract with a new client. Once you bill over $500 with your client, the fee will be 10%.</div>
                    </div>
                    <div class="col-md-5 col-sm-7 col-xs-8">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="text-muted font_12">The estimated amount you'll receive after service fees</div>
                    </div>
                    <div class="col-md-5 col-sm-7 col-xs-8">
                        <div class="d-flex align-items-center">
                            <div class="main_rate text-end position-relative">
