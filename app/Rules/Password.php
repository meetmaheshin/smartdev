    ...
    public function message()
    {
        switch (true) {
            ...
            case ! $this->uppercasePasses:
                return 'The :attribute must be at least one uppercase character.';

            case ! $this->numericPasses:
                return 'The :attribute must be at least one number.';
            ...
            case ! $this->uppercasePasses
                ...
                return 'The :attribute must be  contain at least one uppercase character, one number, and one special character.';
